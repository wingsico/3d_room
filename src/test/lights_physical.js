...
function init() {
  ...
  textureLoader.load(require("assets/planets/earth_atmos_2048.jpg"), function (map) {
    map.anisotropy = 4;
    ballMat.map = map;
    ballMat.needsUpdate = true;
  });
  textureLoader.load(require("assets/planets/earth_specular_2048.jpg"), function (map) {
    map.anisotropy = 4;
